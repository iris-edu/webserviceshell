...
//@ApplicationPath("/")
public class MyAppRC extends ResourceConfig {
    
  public static final Logger logger = Logger.getLogger(MyApplication.class);

  @Inject
  public MyAppRC(ServiceLocator serviceLocator, @Context ServletContext servletContext) {
    System.out.println("*****constr MyAppRC Inject, serviceLocator: " + serviceLocator);
...
//        Injections.newBinder(appScope.getSingletonWrapper()).to(SingletonWrapper.class), dc);
    ...
    System.out.println("*****constr MyAppRC ctxPath: " + servletContext.getContextPath());
  }
  
  public MyAppRC() {
    System.out.println("*****regconstr MyAppRC regular constructor");
  }
  ...
  private void addEndpoint(String epPath, Class epClass, String methodName) {
    ...
    try {
        ...
        System.out.println("*****constr MyAppRC endpoint: " + epPath
    ...
    System.out.println("*****constr MyAppRC Inject, res_dwv: " + endpointRes);
    System.out.println("*****constr MyAppRC Inject, res_dwv name: " + endpointRes.getName());
    System.out.println("*****constr MyAppRC Inject, res_dwv path: " + endpointRes.getPath());
  }
}
